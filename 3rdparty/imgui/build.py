...
wanted_backends = ["sdlgpu3","sdl3", "sdlrenderer3", "metal", "opengl3"]
...
def main():
	...
	compile_flags = platform_select({
		...
		"linux, darwin": ['-DIMGUI_IMPL_API=extern\"C\"', "-fPIC", "-fno-exceptions", "-fno-rtti", "-fno-threadsafe-statics", "-std=c++17"],
	})
