...
## Help wanted!
 ...
 - If there are any issues, or this package doesn't do everything you want it to, feel free to submit a PR, or message me on Discord @yakvi. Be advised that occasionally I tend to disappear from online life.
 - A few useful examples have yet to be created in `examples/`. See the table above.
